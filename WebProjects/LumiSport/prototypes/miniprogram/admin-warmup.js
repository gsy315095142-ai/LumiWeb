...
var warmupGameMap = {
  '疾速冰球': {
    label: '疾速冰球 · 新手教程',
    doc: '../../docs/warmup/speed-hockey.html',
    steps: ['接球', '属性切换', '投球', '综合练习']
  },
  '烈焰拳王': {
    label: '烈焰拳王 · 握拳教学',
    doc: '../../docs/warmup/blazing-boxer.html',
    steps: ['出拳', '格挡', '闪避', '侧步', '重拳', '连招', '反击', '综合考核']
  },
  '雷霆击剑': {
    label: '雷霆击剑 · 持剑教学',
    doc: '../../docs/warmup/thunder-fencing.html',
    steps: ['刺击', '格挡', '位移', '综合练习']
  }
};
...
function getWarmupGameInfo(gameStr) {
  ...
  return { label: '通用热身教程', doc: '../../docs/warmup/common-rules.html', steps: ['准备', '基础操作', '进阶练习', '综合考核'] };
}
