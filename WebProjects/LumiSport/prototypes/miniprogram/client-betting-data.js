...
// 当前用户预测币余额（演示用，报名扣费/取消退还）
var myGameCoin = 1250;

// 当前用户礼品点数余额（演示用，兑换商品扣减）
var myExchangeCoin = 340;

// 我已预测提交记录（按场次累计，红/蓝分别累计），预测提交确认后持久显示
var myBets = {}; // { mid: { red:金额, blue:金额 } }

// 预测记录（真实数据来源，预言家段位与胜率均由此计算）
// coin：未猜中时消耗的预测币（负数）；猜中时仅展示 ex（礼品点数奖励，不返还预测币）
var betRecords = [
...
// 预言家段位（按累计预测场次划分，min 为进入该段位所需场次）
var prophetTiers = [
...
var storeAds = {
  '🏡 兰陵酒吧': {
    hotel: { badge:'🏨 兰陵大酒店', title:'住客专享 · 入住即送1000预测币', desc:'前台领取实体筹码，扫码兑换即时到账' },
    tag: '今夜精彩赛事 · 参与预测赢好礼',
    zones: {
  ...
  '🍺 啤酒公社': {
    hotel: { badge:'🏨 公社精酿酒店', title:'住客专享 · 畅饮套餐送500预测币', desc:'凭房卡到吧台领取，预测赢取礼品点数' },
    tag: '畅饮 + 预测 · 嗨爆今夜',
    zones: {
      '疾速冰球厅': '🍺 啤酒公社 · 冰球之夜精酿特惠',
      '雷霆击剑厅': '🍺 啤酒公社 · 击剑对决配冰啤',
  ...
  '✨ 星光酒廊': {
    hotel: { badge:'🏨 星光国际酒店', title:'住客专享 · 入住即享888预测币', desc:'扫码即时到账，赛事预测赢豪礼' },
    tag: '星光璀璨 · 预测赢大奖',
    zones: {
      '疾速冰球厅': '✨ 星光酒廊 · 冰球星光夜',
      '雷霆击剑厅': '✨ 星光酒廊 · 剑指巅峰盛典',
